...
public class DataDefinitionResourceTest
	...
	public void testPostSiteDataDefinitionByContentTypeWithNestedFieldsets()
		...
		List<DataDefinitionField> dataDefinitionFields =
			_getDataDefinitionFields(dataDefinition.getDataDefinitionFields());

		Assert.assertEquals(
			dataDefinitionFields.toString(), 5, dataDefinitionFields.size());

		List<String> names = TransformUtil.transform(
			dataDefinitionFields, DataDefinitionField::getName);
	...
	private List<DataDefinitionField> _getDataDefinitionFields(
		DataDefinitionField[] dataDefinitionFields) {
		...
		for (DataDefinitionField dataDefinitionField : dataDefinitionFields) {
			...
			if (nestedDataDefinitionFields != null) {
				allDataDefinitionFields.addAll(
					_getDataDefinitionFields(nestedDataDefinitionFields));
			}
		}
