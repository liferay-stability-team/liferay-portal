...
public class ObjectEntryModelResourcePermissionTest {
	...
	public void testContains() throws Exception {
		_testContainsWhenGuestHasViewOnConnectedSite();
		_testContainsWhenGuestHasViewOnUnconnectedSite();
	}

	private void _setGuestViewPermission(long groupId) throws Exception {
	...
	private void _testContainsWhenGuestHasViewOnConnectedSite()
		throws Exception {
		...
		_setGuestViewPermission(group.getGroupId());
	...
	private void _testContainsWhenGuestHasViewOnUnconnectedSite()
		throws Exception {
