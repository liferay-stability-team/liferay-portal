...
public class ObjectEntryModelListenerAuditTest {
	...
	public void testOnAfterCreateWithLocalizedValues() throws Exception {
		_addObjectEntry("Description", "Descrição");

		JSONObject additionalInfoJSONObject = _pollAdditionalInfoJSONObject();

		Assert.assertEquals(
			"Description",
			additionalInfoJSONObject.getString("description[en_US]"));
		Assert.assertEquals(
			"Descrição",
			additionalInfoJSONObject.getString("description[pt_BR]"));
	}

	@Test
	public void testOnAfterRemoveWithLocalizedValues() throws Exception {
		ObjectEntry objectEntry = _addObjectEntry("Description", "Descrição");
	...
	private ObjectEntry _addObjectEntry(String enUSValue, String ptBRValue)
		throws Exception {
		...
		return _objectEntryLocalService.addObjectEntry(
			...
			null, _getValues(enUSValue, ptBRValue),
			ServiceContextTestUtil.getServiceContext());
	}

	private void _assertModifiedAttributes(String... expectedAttributes) {
		JSONArray jsonArray = _pollAdditionalInfoJSONObject().getJSONArray(
			"attributes");
	...
	private void _testOnAfterUpdateWithDefaultLocaleValue() throws Exception {
		...
		_assertModifiedAttributes(
			"description[en_US]=Description>Description 2");
	}
