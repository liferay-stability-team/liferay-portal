...
public class DDMTemplateItemSelectorViewDescriptorTest {
	...
	public void testSearchContainerExcludesCrossSiteTemplatesForAssetLibraryStructure()
		...
		_setUpDepotConnectedToSites();

		DDMTemplate group1Template = _addDDMTemplate(_group1.getGroupId());
		DDMTemplate group2Template = _addDDMTemplate(_group2.getGroupId());
		DDMTemplate depotTemplate = _addDDMTemplate(_depotEntry.getGroupId());
	...
	public void testSearchContainerReturnsNoTemplatesWhenNavigatingToUnrelatedSite()
		...
		List<DDMTemplate> ddmTemplates = _getDDMTemplates(
			_group2.getGroupId(), _group1.getGroupId());
	...
	private List<DDMTemplate> _getDDMTemplates(
			long scopeGroupId, long refererGroupId)
		throws Exception {
	...
	private void _setUpDepotConnectedToSites() throws Exception {
